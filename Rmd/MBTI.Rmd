...
\
\
Također imamo stupac "MBTI" koji predstavlja tipove ličnosti i razlikujemo razlikujemo [16 vrsta tipova osobnosti](https://www.16personalities.com/personality-types).
```{r}
