...
### Usporedba srednjih težina i visina za četiri grupe osobnosti
...
H0: Nema statistički značajne razlike u srednjim težinama između grupa.
H1: Postoji statistički značajna razlika u srednjim težinama između barem jedne od grupa.
```{r}
...
H0: Nema statistički značajne razlike u srednjim težinama između ekstroverta i introverta.
H1: Postoji statistički značajna razlika u srednjim težinama između ekstroverta i introverta.
```{r}
ekstroverti <- dataset[dataset$IE == "E", ]
introverti <- dataset[dataset$IE == "I", ]

t_test <- t.test(ekstroverti$WEIGHT, introverti$WEIGHT)
t_test
cat("P vrijednost je", t_test$p.value, "\n")
```
Na temelju rezultata testa zaključujemo da ne postoji značajna razlika između težina introverata i ekstroverata.
