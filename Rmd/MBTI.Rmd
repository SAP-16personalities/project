...
U našem podatkovnom skupu imamo stupce "WEIGHT", "HEIGHT" i "MBTI" čija se međusobna raspodjela vidi na sljedećem grafu:
```{r}
...
```
Provest ćemo hi kvadrat test za kategorijske podatke gdje ćemo proučavati stupce "HEIGHT" i "IE" (introvert/ekstrovert) podatkovnog okvira.
```{r}
...
chisq
```
Na temelju rezultata testa zaključujemo da ekstroverstnost nema vete sa visinom.

Sada ćemo postupak ponoviti i proučavati stupce "WEIGHT" i "JP" (produđivanje/opažanje).
```{r}
...
chisq
```
Na temelju rezultata testa zaključujemo da prosuđivanje/opažanje nema veze sa visinom.
